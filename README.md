...
I've submitted the App on **Google Play** and the **Apple Store**, it will be available as soon as their acceptance process is done. For Android [here is the apk built for the target API29](https://github.com/mbruel/ClementineRemote/releases/download/v1.0/ClemRemote_v1.0_api29.apk).
<br/><br/>
